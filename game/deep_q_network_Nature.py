...
class BrainDQN:
    ...
    def __init__(self, actions):
        ...
        self.copyTargetQNetworkOperation = [self.W_conv1_1T.assign(self.W_conv1_1), self.b_conv1_1T.assign(self.b_conv1_1),
                                            self.W_conv2_1T.assign(self.W_conv2_1), self.b_conv2_1T.assign(self.b_conv2_1),
                                            self.W_conv2_2T.assign(self.W_conv2_2), self.b_conv2_2T.assign(self.b_conv2_2),
                                            self.W_conv3_1T.assign(self.W_conv3_1), self.b_conv3_1T.assign(self.b_conv3_1),
                                            self.W_conv3_2T.assign(self.W_conv3_2), self.b_conv3_2T.assign(self.b_conv3_2),
...
def playFlappyBird():
    ...
    actions = 2
    brain = BrainDQN(actions)
    print(brain.get_loss_score_timestep_reward_qtarget_from_file())
